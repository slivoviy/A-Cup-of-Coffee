...
public class Coffee : MonoBehaviour
{
    ...
    private Material LiquidMaterial1;
    private Material LiquidMaterial2;
    private Material LiquidMaterial3;
    private Material LiquidMaterial4;
    private Material LiquidMaterial5;
    ...
    public void Start()
    {
        ...
        if (Liquid1)
        {
            ...
            LiquidMaterial1 = Liquid1.GetComponentInChildren<Renderer>().material;
        }
        if (Liquid2)
        {
            IsLiquid2 = true;
            ...
            LiquidMaterial2 = Liquid2.GetComponentInChildren<Renderer>().material;
        }
        if (Liquid3)
        {
            IsLiquid3 = true;
            ...
            LiquidMaterial3 = Liquid3.GetComponentInChildren<Renderer>().material;
        }
        if (Liquid4)
        {
            IsLiquid4 = true;
            ...
            LiquidMaterial4 = Liquid4.GetComponentInChildren<Renderer>().material;
        }
        ...
        if (Liquid5) {
            ...
            LiquidMaterial5 = Liquid5.GetComponentInChildren<Renderer>().material;
        }
    }
    ...
    public void FixedUpdate()
    {
        if (Input.GetMouseButton(0) && i == 0 && FingerDown1 == 0 && IsLiquid1 == true)
        {
            ...
            liquidParticlesMain.startColor = new ParticleSystem.MinMaxGradient(LiquidMaterial1.color);
        ...
        {
            var liquidParticlesMain = LiquidParticles.main;
            liquidParticlesMain.startColor = new ParticleSystem.MinMaxGradient(LiquidMaterial2.color);
